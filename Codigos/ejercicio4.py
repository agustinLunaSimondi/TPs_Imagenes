...
def ejercicio4():
    ...
    """
    lineas_3 = lineas_hough(copia_imagen_3, lower_thersh = 80, upper_thresh = 100, longitud = 100)
    ...
    for linea in lineas_4:
        x1, y1, x2, y2 = linea[0]
        cv2.line(imagen_4, (x1, y1), (x2, y2), (0, 0, 255), 10)
    ...
    for esquina in esquinas_3:
        y, x = esquina
        cv2.circle(imagen_3, (x, y), radius=1, color=(0, 0, 255), thickness=-1)
    for esquina in esquinas_4:
        y, x = esquina
        cv2.circle(imagen_4, (x, y), radius=9, color=(0, 0, 255), thickness=-1)
